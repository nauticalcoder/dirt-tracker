...
SCREEN_ENDURO_INFO_2 = "enduro-info-2"


class EnduroInfo2(Screen):
    
    def __init__(self, display, fonts):
        super().__init__(SCREEN_ENDURO_INFO_2, display, fonts)
        if not display:
            return
        # Setup sprites
    ...
    def render(self, ride_state, system_state):
        ...
        # Current speed
        self.display.draw_text(60, 12, "Enduro 2", self.fonts["medium"])
