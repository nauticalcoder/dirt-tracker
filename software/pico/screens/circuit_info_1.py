...
class Info1(Screen):
    ...
    def render(self, ride_state, system_state):
        ...
        self.display.draw_text(self.display.width, self.display.height // 2 - text_height // 2, str(ride_state.lap_distance_traveled), self.fonts["bally"])
        self.display.draw_text(0, self.display.height // 2 - text_height // 2, unit_text, self.fonts["bally"])
        self.display.draw_text(self.display.width, self.display.height // 2 - text_height // 2, str(ride_state.lap_elapsed_time), self.fonts["bally"])
        self.display.draw_text(0, self.display.height // 2 - text_height // 2, unit_text, self.fonts["bally"])
